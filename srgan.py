...
class SRGAN():
    ...
    def train(self, epochs, batch_size=1, save_interval=50):
        ...
        for epoch in range(epochs):
            ...
            imgs_hr, imgs_lr = self.data_builder.load_data(batch_size)
    ...
    def save_weights(self, epoch, path='data/weights'):
        self.generator.save_weights(path + '/G.h5')
        self.discriminator.save_weights(path + '/D.h5')
